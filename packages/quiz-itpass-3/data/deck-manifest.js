...
var PLAYABLE_BY_YEAR = { '07_haru': 100, '08_haru': 100, '28_aki': 99 };
var DECK_MAP = {};
...
function getAllLocalDecks() {
  var result = [];
  for (var key in DECK_MAP) if (Object.prototype.hasOwnProperty.call(DECK_MAP, key)) result.push(DECK_MAP[key]);
  return result;
}
