...
'use strict';
/**
 * verify:release:candidate — One-command RC gate for the full app.
 *
 * Builds on verify:sr:release and adds Minium due runtime, Review Center
 * checks, and comprehensive learning path validation.
...
var REPORT_PATH = path.join(IGNORED_DIR, 'verify-release-candidate-report.json');
...
var stepsDef = [
  ...
  { name: 'Miniprogram checks (139 checks)', fn: function () {
  ...
  // Minium due runtime (R2d core)
  { name: 'Minium due runtime (ITP+SG+expired)', fn: function () {
